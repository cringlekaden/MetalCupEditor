...
namespace EditorUI {
    ...
    bool PropertyVec2(const char *label, float *values, float resetValue = 0.0f, float speed = 0.1f, float minValue = 0.0f, float maxValue = 0.0f, const char *format = "%.3f", bool clampValue = false, bool enableReset = false);
