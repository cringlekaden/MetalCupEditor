...
float MCERendererGetSceneUpdateMs(MCE_CTX);
float MCERendererGetFixedUpdateMs(MCE_CTX);
float MCERendererGetLateUpdateMs(MCE_CTX);
float MCERendererGetSnapshotExtractMs(MCE_CTX);
float MCERendererGetRenderGraphEncodeMs(MCE_CTX);
float MCERendererGetScriptFixedMs(MCE_CTX);
float MCERendererGetCharacterFixedMs(MCE_CTX);
float MCERendererGetPhysicsStepMs(MCE_CTX);
float MCERendererGetPhysicsEventsMs(MCE_CTX);
float MCERendererGetScriptPhysicsDispatchMs(MCE_CTX);
float MCERendererGetSceneMs(MCE_CTX);
float MCERendererGetRenderMs(MCE_CTX);
float MCERendererGetRenderBatchMs(MCE_CTX);
...
float MCERendererGetGpuScenePassMs(MCE_CTX);
float MCERendererGetGpuGridPassMs(MCE_CTX);
float MCERendererGetGpuPickingPassMs(MCE_CTX);
float MCERendererGetGpuOutlinePassMs(MCE_CTX);
float MCERendererGetGpuBloomExtractPassMs(MCE_CTX);
float MCERendererGetGpuBloomBlurPassMs(MCE_CTX);
float MCERendererGetGpuFinalCompositePassMs(MCE_CTX);
